...
function useChat(options) {
  ...
  const [setup, setSetup] = React9.useState();
...
function Chat(_a) {
  ...
  return /* @__PURE__ */ React10.createElement("div", __spreadProps(__spreadValues({}, props), { className: "lk-chat" }), /* @__PURE__ */ React10.createElement("ul", { className: "lk-list lk-chat-messages", ref: ulRef }, props.children ? chatMessages.map(
...
function useConnectionState(room) {
  ...
  const observable = React14.useMemo(() => (0, import_components_core5.connectionStateObserver)(r), [r]);
...
function useFocusToggle({ trackRef, trackSource, participant, props }) {
  ...
  const layoutContext = useMaybeLayoutContext();
  const { className } = React16.useMemo(() => (0, import_components_core7.setupFocusToggle)(), []);
  const inFocus = React16.useMemo(() => {
    if (trackRef) {
      return (0, import_components_core7.isTrackReferencePinned)(trackRef, layoutContext == null ? void 0 : layoutContext.pin.state);
    } else if (trackSource) {
  ...
  const mergedProps = React16.useMemo(
    () => mergeProps(props, {
      ...
      onClick: (event) => {
        ...
        if (trackRef && (0, import_components_core7.isTrackReference)(trackRef)) {
          if (inFocus) {
...
function useIsMuted(sourceOrTrackRef, options = {}) {
  ...
  React18.useEffect(() => {
    const listener = (0, import_components_core9.mutedObserver)(ref).subscribe(setIsMuted);
    return () => listener.unsubscribe();
  }, [(0, import_components_core9.getTrackReferenceId)(ref)]);
  return isMuted;
}
...
function useIsSpeaking(participant) {
  const p = useEnsureParticipant(participant);
  const observable = React19.useMemo(() => (0, import_components_core10.createIsSpeakingObserver)(p), [p]);
...
function useMediaDevices({ kind }) {
  const deviceObserver = React23.useMemo(() => (0, import_components_core14.createMediaDeviceObserver)(kind), [kind]);
  const devices = useObservableState(deviceObserver, []);
  return devices;
}
...
function useMediaTrackBySourceOrName(observerOptions, options = {}) {
  var _a;
  const [publication, setPublication] = React24.useState((0, import_components_core16.getTrackByIdentifier)(observerOptions));
  ...
  React24.useEffect(() => {
    ...
    if (track) {
      ...
      if (((_a2 = options.element) == null ? void 0 : _a2.current) && !((0, import_components_core16.isLocal)(observerOptions.participant) && (track == null ? void 0 : track.kind) === "audio")) {
...
function useParticipantTile({
  ...
  const isVideoMuted = useIsMuted(import_livekit_client4.Track.Source.Camera, { participant: trackReference.participant });
  const isAudioMuted = useIsMuted(import_livekit_client4.Track.Source.Microphone, {
...
function useChatToggle({ props }) {
  ...
  const { className } = React32.useMemo(() => (0, import_components_core21.setupChatToggle)(), []);
...
function useTrackMutedIndicator(trackRefOrSource, options = {}) {
  ...
  const { className, mediaMutedObserver } = React33.useMemo(
    () => (0, import_components_core22.setupTrackMutedIndicator)(ref),
    [(0, import_components_core22.getTrackReferenceId)(ref)]
  );
...
var SvgChatIcon = (props) => /* @__PURE__ */ React40.createElement("svg", __spreadValues({ xmlns: "http://www.w3.org/2000/svg", width: 16, height: 18, fill: "none" }, props), /* @__PURE__ */ React40.createElement(
  "path",
  {
    fill: "currentColor",
    fillRule: "evenodd",
...
var SvgChevron = (props) => /* @__PURE__ */ React41.createElement("svg", __spreadValues({ xmlns: "http://www.w3.org/2000/svg", width: 16, height: 16, fill: "none" }, props), /* @__PURE__ */ React41.createElement(
  "path",
  {
    fill: "currentcolor",
    fillRule: "evenodd",
...
var SvgFocusToggleIcon = (props) => /* @__PURE__ */ React42.createElement("svg", __spreadValues({ xmlns: "http://www.w3.org/2000/svg", width: 16, height: 16, fill: "none" }, props), /* @__PURE__ */ React42.createElement("g", { stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 1.5 }, /* @__PURE__ */ React42.createElement("path", { d: "M10 1.75h4.25m0 0V6m0-4.25L9 7M6 14.25H1.75m0 0V10m0 4.25L7 9" })));
var FocusToggleIcon_default = SvgFocusToggleIcon;

// src/assets/icons/LeaveIcon.tsx
var React43 = __toESM(require("react"));
var SvgLeaveIcon = (props) => /* @__PURE__ */ React43.createElement("svg", __spreadValues({ xmlns: "http://www.w3.org/2000/svg", width: 16, height: 16, fill: "none" }, props), /* @__PURE__ */ React43.createElement(
  "path",
  {
    fill: "currentColor",
    fillRule: "evenodd",
...
var SvgLockLockedIcon = (props) => /* @__PURE__ */ React44.createElement("svg", __spreadValues({ xmlns: "http://www.w3.org/2000/svg", width: 16, height: 16, fill: "none" }, props), /* @__PURE__ */ React44.createElement(
  "path",
  {
    fill: "currentcolor",
    fillRule: "evenodd",
...
var SvgMicDisabledIcon = (props) => /* @__PURE__ */ React45.createElement("svg", __spreadValues({ xmlns: "http://www.w3.org/2000/svg", width: 16, height: 16, fill: "currentColor" }, props), /* @__PURE__ */ React45.createElement("path", { d: "M12.227 11.52a5.477 5.477 0 0 0 1.246-2.97.5.5 0 0 0-.995-.1 4.478 4.478 0 0 1-.962 2.359l-1.07-1.07C10.794 9.247 11 8.647 11 8V3a3 3 0 0 0-6 0v1.293L1.354.646a.5.5 0 1 0-.708.708l14 14a.5.5 0 0 0 .708-.708zM8 12.5c.683 0 1.33-.152 1.911-.425l.743.743c-.649.359-1.378.59-2.154.66V15h2a.5.5 0 0 1 0 1h-5a.5.5 0 0 1 0-1h2v-1.522a5.502 5.502 0 0 1-4.973-4.929.5.5 0 0 1 .995-.098A4.5 4.5 0 0 0 8 12.5z" }), /* @__PURE__ */ React45.createElement("path", { d: "M8.743 10.907 5 7.164V8a3 3 0 0 0 3.743 2.907z" }));
var MicDisabledIcon_default = SvgMicDisabledIcon;

// src/assets/icons/MicIcon.tsx
var React46 = __toESM(require("react"));
var SvgMicIcon = (props) => /* @__PURE__ */ React46.createElement("svg", __spreadValues({ xmlns: "http://www.w3.org/2000/svg", width: 16, height: 16, fill: "currentColor" }, props), /* @__PURE__ */ React46.createElement(
  "path",
  {
    fillRule: "evenodd",
...
), /* @__PURE__ */ React46.createElement("path", { d: "M5 3a3 3 0 1 1 6 0v5a3 3 0 0 1-6 0z" }));
var MicIcon_default = SvgMicIcon;

// src/assets/icons/QualityExcellentIcon.tsx
var React47 = __toESM(require("react"));
var SvgQualityExcellentIcon = (props) => /* @__PURE__ */ React47.createElement("svg", __spreadValues({ xmlns: "http://www.w3.org/2000/svg", width: 16, height: 16, fill: "currentcolor" }, props), /* @__PURE__ */ React47.createElement("path", { d: "M0 11.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5zm6-5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5zm6-6a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v15a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5z" }), /* @__PURE__ */ React47.createElement("path", { d: "M0 11.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5zm6-5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5zm6-6a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v15a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5z" }));
var QualityExcellentIcon_default = SvgQualityExcellentIcon;

// src/assets/icons/QualityGoodIcon.tsx
var React48 = __toESM(require("react"));
var SvgQualityGoodIcon = (props) => /* @__PURE__ */ React48.createElement("svg", __spreadValues({ xmlns: "http://www.w3.org/2000/svg", width: 16, height: 16, fill: "currentcolor" }, props), /* @__PURE__ */ React48.createElement("path", { d: "M0 11.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5zm6-5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5z" }), /* @__PURE__ */ React48.createElement("path", { d: "M0 11.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5zm6-5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5z" }), /* @__PURE__ */ React48.createElement("g", { opacity: 0.25 }, /* @__PURE__ */ React48.createElement("path", { d: "M12 .5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v15a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5z" }), /* @__PURE__ */ React48.createElement("path", { d: "M12 .5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v15a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5z" })));
var QualityGoodIcon_default = SvgQualityGoodIcon;

// src/assets/icons/QualityPoorIcon.tsx
var React49 = __toESM(require("react"));
var SvgQualityPoorIcon = (props) => /* @__PURE__ */ React49.createElement("svg", __spreadValues({ xmlns: "http://www.w3.org/2000/svg", width: 16, height: 16, fill: "currentcolor" }, props), /* @__PURE__ */ React49.createElement("path", { d: "M0 11.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5z" }), /* @__PURE__ */ React49.createElement("path", { d: "M0 11.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5z" }), /* @__PURE__ */ React49.createElement("g", { opacity: 0.25 }, /* @__PURE__ */ React49.createElement("path", { d: "M6 6.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5z" }), /* @__PURE__ */ React49.createElement("path", { d: "M6 6.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5zm6-6a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v15a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5z" }), /* @__PURE__ */ React49.createElement("path", { d: "M12 .5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v15a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5z" })));
var QualityPoorIcon_default = SvgQualityPoorIcon;

// src/assets/icons/QualityUnknownIcon.tsx
var React50 = __toESM(require("react"));
var SvgQualityUnknownIcon = (props) => /* @__PURE__ */ React50.createElement("svg", __spreadValues({ xmlns: "http://www.w3.org/2000/svg", width: 16, height: 16, fill: "currentColor" }, props), /* @__PURE__ */ React50.createElement("g", { opacity: 0.25 }, /* @__PURE__ */ React50.createElement("path", { d: "M0 11.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5v-4Zm6-5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5v-9Zm6-6a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v15a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5V.5Z" }), /* @__PURE__ */ React50.createElement("path", { d: "M0 11.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5v-4Zm6-5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5v-9Zm6-6a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v15a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5V.5Z" })));
var QualityUnknownIcon_default = SvgQualityUnknownIcon;

// src/assets/icons/ScreenShareIcon.tsx
var React51 = __toESM(require("react"));
var SvgScreenShareIcon = (props) => /* @__PURE__ */ React51.createElement("svg", __spreadValues({ xmlns: "http://www.w3.org/2000/svg", width: 20, height: 16, fill: "none" }, props), /* @__PURE__ */ React51.createElement(
  "path",
  {
    fill: "currentColor",
    fillRule: "evenodd",
...
var SvgScreenShareStopIcon = (props) => /* @__PURE__ */ React52.createElement("svg", __spreadValues({ xmlns: "http://www.w3.org/2000/svg", width: 20, height: 16, fill: "none" }, props), /* @__PURE__ */ React52.createElement("g", { fill: "currentColor" }, /* @__PURE__ */ React52.createElement("path", { d: "M7.28 4.22a.75.75 0 0 0-1.06 1.06L8.94 8l-2.72 2.72a.75.75 0 1 0 1.06 1.06L10 9.06l2.72 2.72a.75.75 0 1 0 1.06-1.06L11.06 8l2.72-2.72a.75.75 0 0 0-1.06-1.06L10 6.94z" }), /* @__PURE__ */ React52.createElement(
  "path",
  {
    fillRule: "evenodd",
...
var SvgSpinnerIcon = (props) => /* @__PURE__ */ React53.createElement("svg", __spreadValues({ xmlns: "http://www.w3.org/2000/svg", width: 16, height: 16, fill: "none" }, props), /* @__PURE__ */ React53.createElement(
  "path",
  {
    fill: "currentColor",
    fillRule: "evenodd",
...
var SvgUnfocusToggleIcon = (props) => /* @__PURE__ */ React54.createElement("svg", __spreadValues({ xmlns: "http://www.w3.org/2000/svg", width: 16, height: 16, fill: "none" }, props), /* @__PURE__ */ React54.createElement("g", { stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 1.5 }, /* @__PURE__ */ React54.createElement("path", { d: "M13.25 7H9m0 0V2.75M9 7l5.25-5.25M2.75 9H7m0 0v4.25M7 9l-5.25 5.25" })));
...
function DisconnectButton(props) {
  ...
  return /* @__PURE__ */ React60.createElement("button", __spreadValues({}, buttonProps), props.children);
}
...
function FocusToggle(_a) {
  ...
  return /* @__PURE__ */ React61.createElement(LayoutContext.Consumer, null, (layoutContext) => layoutContext !== void 0 && /* @__PURE__ */ React61.createElement("button", __spreadValues({}, mergedProps), props.children ? props.children : inFocus ? /* @__PURE__ */ React61.createElement(UnfocusToggleIcon_default, null) : /* @__PURE__ */ React61.createElement(FocusToggleIcon_default, null)));
}
...
function StartAudio(_a) {
  ...
  return /* @__PURE__ */ React62.createElement("button", __spreadValues({}, mergedProps), label);
}
...
function ConnectionQualityIndicator(props) {
  ...
  return /* @__PURE__ */ React63.createElement("div", __spreadValues({}, elementProps), (_a = props.children) != null ? _a : getConnectionQualityIcon(quality));
}
...
function ParticipantName(_a) {
  ...
  const p = useEnsureParticipant(participant);
  const { className, infoObserver } = React64.useMemo(() => {
    return (0, import_components_core28.setupParticipantName)(p);
  }, [p]);
  ...
  return /* @__PURE__ */ React64.createElement("span", __spreadValues({}, mergedProps), name !== "" ? name : identity, props.children);
}
...
function TrackMutedIndicator(_a) {
  ...
  const htmlProps = React65.useMemo(
    () => mergeProps2(props, {
      className
    }),
    [className, props]
  ...
  return /* @__PURE__ */ React65.createElement("div", __spreadProps(__spreadValues({}, htmlProps), { "data-lk-muted": isMuted }), (_b2 = props.children) != null ? _b2 : getSourceIcon((_a2 = trackRef == null ? void 0 : trackRef.source) != null ? _a2 : source, !isMuted));
}
...
function useIsEncrypted(participant) {
  ...
  const observer = React68.useMemo(() => (0, import_components_core30.encryptionStatusObservable)(room, p), [room, p]);
...
function ParticipantContextIfNeeded(props) {
  ...
  return props.participant && !hasContext ? /* @__PURE__ */ React69.createElement(ParticipantContext.Provider, { value: props.participant }, props.children) : /* @__PURE__ */ React69.createElement(React69.Fragment, null, props.children);
}
function TrackRefContextIfNeeded(props) {
  const hasContext = !!useMaybeTrackRefContext();
  return props.trackRef && !hasContext ? /* @__PURE__ */ React69.createElement(TrackRefContext.Provider, { value: props.trackRef }, props.children) : /* @__PURE__ */ React69.createElement(React69.Fragment, null, props.children);
}
function ParticipantTile(_a) {
  ...
  const maybeTrackRef = useMaybeTrackRefContext();
  const p = useEnsureParticipant(participant);
  const trackReference = React69.useMemo(() => {
  ...
  const handleSubscribe = React69.useCallback(
    (subscribed) => {
      if (trackReference.source && !subscribed && layoutContext && layoutContext.pin.dispatch && (0, import_components_core31.isTrackReferencePinned)(trackReference, layoutContext.pin.state)) {
        layoutContext.pin.dispatch({ msg: "clear_pin" });
      }
    },
    [trackReference, layoutContext]
  );
  return /* @__PURE__ */ React69.createElement("div", __spreadValues({ style: { position: "relative" } }, elementProps), /* @__PURE__ */ React69.createElement(TrackRefContextIfNeeded, { trackRef: trackReference }, /* @__PURE__ */ React69.createElement(ParticipantContextIfNeeded, { participant: trackReference.participant }, children != null ? children : /* @__PURE__ */ React69.createElement(React69.Fragment, null, (0, import_components_core31.isTrackReference)(trackReference) && (((_b2 = trackReference.publication) == null ? void 0 : _b2.kind) === "video" || trackReference.source === import_livekit_client11.Track.Source.Camera || trackReference.source === import_livekit_client11.Track.Source.ScreenShare) ? /* @__PURE__ */ React69.createElement(
    VideoTrack,
    {
  ...
  ) : (0, import_components_core31.isTrackReference)(trackReference) && /* @__PURE__ */ React69.createElement(
    AudioTrack,
    {
      trackRef: trackReference,
      onSubscriptionStatusChanged: handleSubscribe
    }
  ), /* @__PURE__ */ React69.createElement("div", { className: "lk-participant-placeholder" }, /* @__PURE__ */ React69.createElement(ParticipantPlaceholder_default, null)), /* @__PURE__ */ React69.createElement("div", { className: "lk-participant-metadata" }, /* @__PURE__ */ React69.createElement("div", { className: "lk-participant-metadata-item" }, trackReference.source === import_livekit_client11.Track.Source.Camera ? /* @__PURE__ */ React69.createElement(React69.Fragment, null, isEncrypted && /* @__PURE__ */ React69.createElement(LockLockedIcon_default, { style: { marginRight: "0.25rem" } }), /* @__PURE__ */ React69.createElement(
    TrackMutedIndicator,
    {
      source: import_livekit_client11.Track.Source.Microphone,
      show: "muted"
    }
  ), /* @__PURE__ */ React69.createElement(ParticipantName, null)) : /* @__PURE__ */ React69.createElement(React69.Fragment, null, /* @__PURE__ */ React69.createElement(ScreenShareIcon_default, { style: { marginRight: "0.25rem" } }), /* @__PURE__ */ React69.createElement(ParticipantName, null, "'s screen"))), /* @__PURE__ */ React69.createElement(ConnectionQualityIndicator, { className: "lk-participant-metadata-item" }))), /* @__PURE__ */ React69.createElement(FocusToggle, { trackRef: trackReference }))));
}

// src/components/layout/FocusLayout.tsx
function FocusLayoutContainer(props) {
  const elementProps = mergeProps2(props, { className: "lk-focus-layout" });
  return /* @__PURE__ */ React70.createElement("div", __spreadValues({}, elementProps), props.children);
}
function FocusLayout(_a) {
  ...
  return /* @__PURE__ */ React70.createElement(ParticipantTile, __spreadValues(__spreadValues({}, trackReference), htmlProps));
}
...
function TrackLoop(_a) {
  ...
  return /* @__PURE__ */ React71.createElement(React71.Fragment, null, tracks.map((trackReference) => {
    return /* @__PURE__ */ React71.createElement(
      TrackRefContext.Provider,
      {
        value: trackReference,
        key: (0, import_components_core32.getTrackReferenceId)(trackReference)
      },
...
function PaginationControl({
  ...
  const [interactive, setInteractive] = React72.useState(false);
  React72.useEffect(() => {
    let subscription;
    if (connectedElement) {
  ...
  return /* @__PURE__ */ React72.createElement("div", { className: "lk-pagination-control", "data-lk-user-interaction": interactive }, /* @__PURE__ */ React72.createElement("button", { className: "lk-button", onClick: prevPage }, /* @__PURE__ */ React72.createElement(Chevron_default, null)), /* @__PURE__ */ React72.createElement("span", { className: "lk-pagination-count" }, `${currentPage} of ${totalPageCount}`), /* @__PURE__ */ React72.createElement("button", { className: "lk-button", onClick: nextPage }, /* @__PURE__ */ React72.createElement(Chevron_default, null)));
}
...
function PaginationIndicator({ totalPageCount, currentPage }) {
  const bubbles = new Array(totalPageCount).fill("").map((_, index) => {
    if (index + 1 === currentPage) {
      return /* @__PURE__ */ React73.createElement("span", { "data-lk-active": true, key: index });
    } else {
      return /* @__PURE__ */ React73.createElement("span", { key: index });
    }
  });
  return /* @__PURE__ */ React73.createElement("div", { className: "lk-pagination-indicator" }, bubbles);
}

// src/components/layout/GridLayout.tsx
function GridLayout(_a) {
  var _b = _a, { tracks } = _b, props = __objRest(_b, ["tracks"]);
  const gridEl = React74.createRef();
  const elementProps = React74.useMemo(
  ...
  return /* @__PURE__ */ React74.createElement("div", __spreadValues({ ref: gridEl, "data-lk-pagination": pagination.totalPageCount > 1 }, elementProps), /* @__PURE__ */ React74.createElement(TrackLoop, { tracks: pagination.tracks }, props.children), tracks.length > layout.maxTiles && /* @__PURE__ */ React74.createElement(React74.Fragment, null, /* @__PURE__ */ React74.createElement(
    PaginationIndicator,
    {
      totalPageCount: pagination.totalPageCount,
      currentPage: pagination.currentPage
    }
  ), /* @__PURE__ */ React74.createElement(PaginationControl, __spreadValues({ pagesContainer: gridEl }, pagination))));
}
...
function CarouselLayout(_a) {
  ...
  const asideEl = React75.useRef(null);
  const [prevTiles, setPrevTiles] = React75.useState(0);
  ...
  return /* @__PURE__ */ React75.createElement("aside", __spreadValues({ key: carouselOrientation, className: "lk-carousel", ref: asideEl }, props), /* @__PURE__ */ React75.createElement(TrackLoop, { tracks: sortedTiles }, props.children));
}
...
function LayoutContextProvider({
  ...
  return /* @__PURE__ */ React76.createElement(LayoutContext.Provider, { value: layoutContextValue }, children);
}
...
function AudioVisualizer(_a) {
  ...
  var _a2, _b2;
  const [volumeBars, setVolumeBars] = React77.useState([]);
  const svgWidth = 200;
  const svgHeight = 90;
  const barWidth = 6;
  const barSpacing = 4;
  ...
  return /* @__PURE__ */ React77.createElement(
    ...
    /* @__PURE__ */ React77.createElement("rect", { x: "0", y: "0", width: "100%", height: "100%" }),
    /* @__PURE__ */ React77.createElement(
      ...
      volumeBars.map((vol, idx) => /* @__PURE__ */ React77.createElement(
        "rect",
        {
          key: idx,
...
function ParticipantLoop(_a) {
  ...
  return /* @__PURE__ */ React78.createElement(React78.Fragment, null, participants.map((participant) => /* @__PURE__ */ React78.createElement(ParticipantContext.Provider, { value: participant, key: participant.identity }, cloneSingleChild(props.children))));
}
...
function RoomAudioRenderer() {
  ...
  }).filter((ref) => !(0, import_components_core36.isLocal)(ref.participant));
  React79.useEffect(() => {
    tracks.forEach((track) => track.publication.setSubscribed(true));
  }, [tracks]);
  return /* @__PURE__ */ React79.createElement("div", { style: { display: "none" } }, tracks.map((trackRef) => /* @__PURE__ */ React79.createElement(AudioTrack, { key: (0, import_components_core36.getTrackReferenceId)(trackRef), trackRef })));
}

// src/components/Toast.tsx
var React80 = __toESM(require("react"));
function Toast(props) {
  const htmlProps = React80.useMemo(() => mergeProps2(props, { className: "lk-toast" }), [props]);
  return /* @__PURE__ */ React80.createElement("div", __spreadValues({}, htmlProps), props.children);
}
...
function ParticipantAudioTile(_a) {
  ...
  return /* @__PURE__ */ React81.createElement("div", __spreadValues({ style: { position: "relative" } }, elementProps), /* @__PURE__ */ React81.createElement(ParticipantContextIfNeeded, { participant: p }, children != null ? children : /* @__PURE__ */ React81.createElement(React81.Fragment, null, /* @__PURE__ */ React81.createElement(AudioTrack, { source: source != null ? source : import_livekit_client14.Track.Source.Microphone }), /* @__PURE__ */ React81.createElement(AudioVisualizer, null), /* @__PURE__ */ React81.createElement("div", { className: "lk-participant-metadata" }, /* @__PURE__ */ React81.createElement("div", { className: "lk-participant-metadata-item" }, /* @__PURE__ */ React81.createElement(TrackMutedIndicator, { source: import_livekit_client14.Track.Source.Microphone }), /* @__PURE__ */ React81.createElement(ParticipantName, null)), /* @__PURE__ */ React81.createElement(ConnectionQualityIndicator, { className: "lk-participant-metadata-item" })))));
}
...
function ControlBar(_a) {
  ...
  var _a2, _b2, _c, _d, _e;
  const [isChatOpen, setIsChatOpen] = React83.useState(false);
  const layoutContext = useMaybeLayoutContext();
  React83.useEffect(() => {
    var _a3, _b3;
  ...
  const showIcon = React83.useMemo(
    () => variation === "minimal" || variation === "verbose",
    [variation]
  );
  const showText = React83.useMemo(
    () => variation === "textOnly" || variation === "verbose",
    [variation]
  );
  const browserSupportsScreenSharing = (0, import_components_core37.supportsScreenSharing)();
  const [isScreenShareEnabled, setIsScreenShareEnabled] = React83.useState(false);
  const onScreenShareChange = (enabled) => {
    setIsScreenShareEnabled(enabled);
  };
  const htmlProps = mergeProps2({ className: "lk-control-bar" }, props);
  return /* @__PURE__ */ React83.createElement("div", __spreadValues({}, htmlProps), visibleControls.microphone && /* @__PURE__ */ React83.createElement("div", { className: "lk-button-group" }, /* @__PURE__ */ React83.createElement(TrackToggle, { source: import_livekit_client16.Track.Source.Microphone, showIcon }, showText && "Microphone"), /* @__PURE__ */ React83.createElement("div", { className: "lk-button-group-menu" }, /* @__PURE__ */ React83.createElement(MediaDeviceMenu, { kind: "audioinput" }))), visibleControls.camera && /* @__PURE__ */ React83.createElement("div", { className: "lk-button-group" }, /* @__PURE__ */ React83.createElement(TrackToggle, { source: import_livekit_client16.Track.Source.Camera, showIcon }, showText && "Camera"), /* @__PURE__ */ React83.createElement("div", { className: "lk-button-group-menu" }, /* @__PURE__ */ React83.createElement(MediaDeviceMenu, { kind: "videoinput" }))), visibleControls.screenShare && browserSupportsScreenSharing && /* @__PURE__ */ React83.createElement(
    TrackToggle,
    {
      source: import_livekit_client16.Track.Source.ScreenShare,
      captureOptions: { audio: true, selfBrowserSurface: "include" },
      showIcon,
      onChange: onScreenShareChange
    },
    showText && (isScreenShareEnabled ? "Stop screen share" : "Share screen")
  ), visibleControls.chat && /* @__PURE__ */ React83.createElement(ChatToggle, null, showIcon && /* @__PURE__ */ React83.createElement(ChatIcon_default, null), showText && "Chat"), visibleControls.leave && /* @__PURE__ */ React83.createElement(DisconnectButton, null, showIcon && /* @__PURE__ */ React83.createElement(LeaveIcon_default, null), showText && "Leave"), /* @__PURE__ */ React83.createElement(StartAudio, { label: "Start Audio" }));
}
...
function VideoConference(_a) {
  ...
  var _a2, _b2;
  const [widgetState, setWidgetState] = React84.useState({
    showChat: false,
    unreadMessages: 0
  });
  const lastAutoFocusedScreenShareTrack = React84.useRef(null);
  const tracks = useTracks(
    ...
    { updateOnlyOn: [import_livekit_client17.RoomEvent.ActiveSpeakersChanged], onlySubscribed: false }
  );
  const widgetUpdate = (state) => {
    import_components_core38.log.debug("updating widget state", state);
    setWidgetState(state);
  };
  const layoutContext = useCreateLayoutContext();
  const screenShareTracks = tracks.filter(import_components_core38.isTrackReference).filter((track) => track.publication.source === import_livekit_client17.Track.Source.ScreenShare);
  const focusTrack = (_a2 = usePinnedTracks(layoutContext)) == null ? void 0 : _a2[0];
  const carouselTracks = tracks.filter((track) => !(0, import_components_core38.isEqualTrackRef)(track, focusTrack));
  React84.useEffect(() => {
    var _a3, _b3, _c, _d;
    if (screenShareTracks.some((track) => track.publication.isSubscribed) && lastAutoFocusedScreenShareTrack.current === null) {
      import_components_core38.log.debug("Auto set screen share focus:", { newScreenShareTrack: screenShareTracks[0] });
      ...
      import_components_core38.log.debug("Auto clearing screen share focus.");
  ...
  return /* @__PURE__ */ React84.createElement("div", __spreadValues({ className: "lk-video-conference" }, props), (0, import_components_core38.isWeb)() && /* @__PURE__ */ React84.createElement(
    LayoutContextProvider,
    {
      value: layoutContext,
      onWidgetChange: widgetUpdate
    },
    /* @__PURE__ */ React84.createElement("div", { className: "lk-video-conference-inner" }, !focusTrack ? /* @__PURE__ */ React84.createElement("div", { className: "lk-grid-layout-wrapper" }, /* @__PURE__ */ React84.createElement(GridLayout, { tracks }, /* @__PURE__ */ React84.createElement(ParticipantTile, null))) : /* @__PURE__ */ React84.createElement("div", { className: "lk-focus-layout-wrapper" }, /* @__PURE__ */ React84.createElement(FocusLayoutContainer, null, /* @__PURE__ */ React84.createElement(CarouselLayout, { tracks: carouselTracks }, /* @__PURE__ */ React84.createElement(ParticipantTile, null)), focusTrack && /* @__PURE__ */ React84.createElement(FocusLayout, { trackRef: focusTrack }))), /* @__PURE__ */ React84.createElement(ControlBar, { controls: { chat: true } })),
  ...
  ), /* @__PURE__ */ React84.createElement(RoomAudioRenderer, null), /* @__PURE__ */ React84.createElement(ConnectionStateToast, null));
}
...
function AudioConference(_a) {
  ...
  const [widgetState, setWidgetState] = React85.useState({
    showChat: false,
    unreadMessages: 0
  });
  const participants = useParticipants();
  return /* @__PURE__ */ React85.createElement(LayoutContextProvider, { onWidgetChange: setWidgetState }, /* @__PURE__ */ React85.createElement("div", __spreadValues({ className: "lk-audio-conference" }, props), /* @__PURE__ */ React85.createElement("div", { className: "lk-audio-conference-stage" }, /* @__PURE__ */ React85.createElement(ParticipantLoop, { participants }, /* @__PURE__ */ React85.createElement(ParticipantAudioTile, null))), /* @__PURE__ */ React85.createElement(
    ControlBar,
    {
      controls: { microphone: true, screenShare: false, camera: false, chat: true }
    }
  ), widgetState.showChat && /* @__PURE__ */ React85.createElement(Chat, null)));
}
