...
function useParticipantPermissions(options = {}) {
  const p = useEnsureParticipant(options.participant);
  const permissionObserver = React29.useMemo(() => participantPermissionObserver2(p), [p]);
...
function useIsEncrypted(participant) {
  ...
  const observer = React77.useMemo(() => encryptionStatusObservable(room, p), [room, p]);
...
function ParticipantTile(_a) {
  ...
  return /* @__PURE__ */ React78.createElement("div", __spreadValues({ style: { position: "relative" } }, elementProps), /* @__PURE__ */ React78.createElement(TrackRefContextIfNeeded, { trackRef: trackReference }, /* @__PURE__ */ React78.createElement(ParticipantContextIfNeeded, { participant: trackReference.participant }, children != null ? children : /* @__PURE__ */ React78.createElement(React78.Fragment, null, isTrackReference3(trackReference) && (((_b2 = trackReference.publication) == null ? void 0 : _b2.kind) === "video" || trackReference.source === Track4.Source.Camera || trackReference.source === Track4.Source.ScreenShare) ? /* @__PURE__ */ React78.createElement(
    VideoTrack,
    {
  ...
  ) : isTrackReference3(trackReference) && /* @__PURE__ */ React78.createElement(
    AudioTrack,
    {
      trackRef: trackReference,
      onSubscriptionStatusChanged: handleSubscribe
    }
  ), /* @__PURE__ */ React78.createElement("div", { className: "lk-participant-placeholder" }, /* @__PURE__ */ React78.createElement(ParticipantPlaceholder_default, null)), /* @__PURE__ */ React78.createElement("div", { className: "lk-participant-metadata" }, /* @__PURE__ */ React78.createElement("div", { className: "lk-participant-metadata-item" }, trackReference.source === Track4.Source.Camera ? /* @__PURE__ */ React78.createElement(React78.Fragment, null, isEncrypted && /* @__PURE__ */ React78.createElement(LockLockedIcon_default, { style: { marginRight: "0.25rem" } }), /* @__PURE__ */ React78.createElement(
    TrackMutedIndicator,
    {
...
function LayoutContextProvider({
  ...
  React85.useEffect(() => {
    log9.debug("Widget Updated", { widgetState: layoutContextValue.widget.state });
...
function AudioVisualizer(_a) {
  ...
  if (!ref) {
    ...
    ref = { participant: p, source: Track5.Source.Microphone };
  }
...
function RoomAudioRenderer() {
  ...
  return /* @__PURE__ */ React89.createElement("div", { style: { display: "none" } }, tracks.map((trackRef) => /* @__PURE__ */ React89.createElement(AudioTrack, { key: getTrackReferenceId4(trackRef), trackRef })));
}
...
function MediaDeviceMenu(_a) {
  ...
  const handleActiveDeviceChange = (kind2, deviceId) => {
    log10.debug("handle device change");
    setIsOpen(false);
...
import { isEqualTrackRef, isTrackReference as isTrackReference4, isWeb, log as log12 } from "@livekit/components-core";
import { RoomEvent as RoomEvent2, Track as Track10 } from "livekit-client";
...
function VideoConference(_a) {
  ...
  const screenShareTracks = tracks.filter(isTrackReference4).filter((track) => track.publication.source === Track10.Source.ScreenShare);
  ...
  return /* @__PURE__ */ React99.createElement("div", __spreadValues({ className: "lk-video-conference" }, props), isWeb() && /* @__PURE__ */ React99.createElement(
